...
STATIC mp_obj_t mymodule_myclass_make_new(const mp_obj_type_t *type, size_t n_args,
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(mymodule_myclass___exit___obj, 4, 4,
mymodule_myclass_obj___exit__);
